...
OUTPUT_DIR = "public/images/cards"
...
def main():
    ...
    for skill in skills_data:
        ...
        card_tier = skill.get("cardTier", "1")
...
#        skill_type = skill.get("type", "N/A")
        ...
        prompt_text = f"""
a card for the skill for a litrpg game, the time period is modern times after year 2020, but the weapons are classic melee, and armor is a mix of classic and modern, magic exists and is used. these cards are monster drops they are stacked to create skills both magical and non-magical. Cards should not feature people or creatures but instead use symbols, icons, and abstract representations.
{{
  "name": "{name}",
  "tier": "{card_tier}",
